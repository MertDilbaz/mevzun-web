<footer id="footer" class="w-full border-t border-[#e7e9ec] bg-white">
    <div class="mx-auto max-w-[1360px] px-5 py-8 sm:px-8 lg:px-10 lg:py-9">
        <div class="flex flex-col gap-8 lg:flex-row lg:items-end lg:justify-between">
            ...
            <nav aria-label="Alt navigasyon" class="flex flex-wrap items-center gap-x-6 gap-y-3 text-[13px] text-[#596579]">
            ...
            <div class="flex flex-col items-start gap-2 text-[12px] text-[#8791a0] lg:items-end">
