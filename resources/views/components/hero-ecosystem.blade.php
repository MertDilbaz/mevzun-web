<div class="hero-ecosystem-shell relative w-full overflow-hidden rounded-[6px] border border-[var(--border)] bg-[var(--bg-surface)] px-5 py-6 sm:px-7 lg:min-h-[520px] lg:px-8 lg:py-7">
    <h2 class="relative z-20 text-[24px] font-semibold leading-tight tracking-[-0.02em] text-[var(--text-primary)] sm:text-[28px]">
    ...
    <div class="relative mt-5 hidden min-h-[430px] lg:block">
        ...
        <div class="absolute bottom-[6%] right-[1%] z-10 max-w-[120px] rotate-[-7deg] text-right text-[13px] font-medium italic leading-[1.35] text-[var(--accent)] opacity-80">
